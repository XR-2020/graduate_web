    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-tickets"></i>教研成果</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container" style="width: 1000px">
            ...
            <router-link to="/教研成果申报">
                <el-button type="primary">教研成果申报</el-button>
            </router-link>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            handleDetail(index, row){
                getNewSystemDetail({id: row.id,type:row.type}).then(res =>{
            ...
            handleEdit(index, row) {
                getNewSystemBadge({id: row.id,type:row.type}).then(res =>{
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        deleteOneNewSystem({id: row.id}).then(res=>{
                            this.getData();
            ...
            delAll() {
                if (this.idList.length>0){
                    this.$confirm('确定要删除吗？', '提示', {
                        ...
                        .then(() => {
                            deleteNewSystem({ ids: this.idList }).then(res => {
                                this.$message.success("删除成功");
