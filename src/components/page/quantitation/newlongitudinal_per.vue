    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-tickets"></i>纵向结题</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container" style="width: 1000px">
            <div class="handle-box">
                ...
                <el-button icon="search" type="primary" style="float: right" @click="crawlerWeb('社科处_3.纵向结题')">爬取原网站</el-button>
            </div>
            <el-table :data="tableData" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="danwei" label="组织结题单位" align="center">
                </el-table-column>
                <el-table-column prop="xiangmujibie" label="项目类别" align="center">
                </el-table-column>
                <el-table-column prop="jietidengji" label="结题等级" align="center">
                </el-table-column>
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="50%">
            <el-form ref="form" :model="form" label-width="100px">
                ...
                <el-form-item label="项目级别">
                    <el-input style="width: 310px" v-model="form.xiangmujibie"></el-input>
                </el-form-item>
                <el-form-item label="结题等级">
                    <el-input style="width: 310px" v-model="form.jietidengji"></el-input>
                </el-form-item>
...
import {
    deleteOneSheKeChu,
    deleteSheKeChu, editSheKeChu,
    getAllSheKeChu,
    getSearchSheKeChu, getSheKeChuDetail, getSheKeChuDetailBadge
} from "../../../api/SheKeChuAPI";
    export default {
        name: 'newlongitudinal_per',
        data() {
            return {
            ...
            delAll() {
                if (this.idList.length>0){
                    this.$confirm('确定要删除吗？', '提示', {
                        ...
                        .then(() => {
                            deleteSheKeChu({ ids: this.idList,type:'社科处_3.纵向结题' }).then(res => {
                                this.$message.success("删除成功");
                                this.getData();
                            });
                        });
