    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-tickets"></i>著作</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container" style="width: 1000px">
            <div class="handle-box">
                ...
                <el-button icon="search" type="primary" style="float: right" @click="crawlerWeb('科技处_著作')">爬取原网站</el-button>
            </div>
...
<!--                </el-table-column>-->
            ...
            <router-link to="/合并申报">
                <el-button type="primary">著作申报</el-button>
            </router-link>
        </div>
        ...
        methods: {
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        deleteOneZhuoZuo({id: row.id}).then(res=>{
                            this.getData();
