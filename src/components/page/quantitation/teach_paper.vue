    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-tickets"></i>教研论文</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container" style="width: 1000px">
            <div class="handle-box">
                ...
                <el-button icon="search" type="primary" style="float: right" @click="crawlerWeb('教务处-教研科_教研论文')">爬取原网站</el-button>
            </div>
...
<!--                </el-table-column>-->
            ...
            <router-link to="/教研论文申报">
                <el-button type="primary">教研论文申报</el-button>
            </router-link>
        </div>
...
import {crawlerWebSite, getTeacherList} from "../../../api/commonAPI";
    export default {
        ...
        methods: {
            ...
            getData() {
                if(this.query.key!==''){
                    getSearchJiaoYanLunWen(this.query).then(res =>{
                        this.tableData = res.list
                        this.pageTotal=res.pageTotal
                    } )
                }else{
                    getAllJiaoYanLunWen(this.query).then(res=>{
                        this.tableData = res.list
                        this.pageTotal=res.pageTotal
                    })
                }
            ...
            handleDetail(index, row){
                getJiaoYanLunWenDetail({id: row.id}).then(res =>{
